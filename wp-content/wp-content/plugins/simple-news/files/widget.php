...
<?php if(get_permalink() === get_permalink(81)){
  } else {
    if ($the_query->have_posts()) { ?>
      <a href="<?php bloginfo('url') ?>/news-pick">
       <ul class="news__list">
       <?php while ($the_query->have_posts()): $the_query->the_post(); ?>
         <?php echo '<h4>' . mb_substr(get_the_title(), 0, 16, 'UTF-8') . '··</h4>';?>
...
<p class="footer__link"><a href="<?php bloginfo('url') ?>/news-pick"><?php _e('# 뉴스 픽', 'simple-news') ?></a></p>
